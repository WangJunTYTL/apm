...
public class GoogleChartGenerator implements StatisticsChartGenerator {
    ...
    public synchronized String getChartUrl() {
        ...
        return generateGoogleChartParams();
...
//        Util.report("maxDataValue " + maxDataValue);
//        Util.report("minTimeValue " + minTimeValue);
//        Util.report("maxTimeValue " + maxTimeValue);
        ChartData chartData = new ChartData();
        chartData.data = tagsToXDataAndYData;
        //Util.report("tagsToXDataAndYData " + JSON.toJSONString(tagsToXDataAndYData));
...
//            Util.report("label " + label);
            chartData.label.add(label);
