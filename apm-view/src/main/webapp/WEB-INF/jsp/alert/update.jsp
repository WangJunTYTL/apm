                ...
                <form role="form">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input value="${alertBuild.service}" id="service" class="form-control"
                                   readonly>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3"
                                      id="term">${alertBuild.term}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="interval">Interval</label>
                            <select class="form-control" id="interval">
                                <option value="1" ${alertBuild.interval == 1 ? "selected":""}>1min
                                </option>
                                <option value="5" ${alertBuild.interval == 5 ? "selected":""}>5min
                                </option>
                                <option value="30" ${alertBuild.interval == 30 ? "selected":""}>
                                    30min
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <c:forEach items="${userGroups}" var="group">
                                <label class="checkbox-inline">
                                    <input type="checkbox" value="${group.key}"
                                    <c:forEach items="${checkedUserGroup}" var="id">
