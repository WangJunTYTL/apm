 ...
 * @author Alex Devine
 */
public class Log4jGraphingStatisticsAppender extends AppenderSkeleton implements AppenderAttachable, Flushable {
    /**
     ...
     */
    protected final static Map<String, Log4jGraphingStatisticsAppender> APPENDERS_BY_NAME =
            Collections.synchronizedMap(new LinkedHashMap<String, Log4jGraphingStatisticsAppender>());
...
//        GoogleChartGenerator retVal = new GoogleChartGenerator(statsValueRetriever);
        BaiduEChartGenerator retVal = new BaiduEChartGenerator(statsValueRetriever);
     ...
     */
    public static Log4jGraphingStatisticsAppender getAppenderByName(String appenderName) {
     ...
     */
    public static Collection<Log4jGraphingStatisticsAppender> getAllGraphingStatisticsAppenders() {
