 ...
 * @author Xu Huisheng
 */
public class LogbackGraphingStatisticsAppender extends AppenderBase<LoggingEvent>
     ...
     */
    protected final static Map<String, LogbackGraphingStatisticsAppender> APPENDERS_BY_NAME =
        Collections.synchronizedMap(new LinkedHashMap<String, LogbackGraphingStatisticsAppender>());
     ...
     */
    public static LogbackGraphingStatisticsAppender getAppenderByName(String appenderName) {
     ...
     */
    public static Collection<LogbackGraphingStatisticsAppender> getAllGraphingStatisticsAppenders() {
