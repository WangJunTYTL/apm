...
public class JdbcLog4jAppender extends AppenderSkeleton {
    ...
    private static JdbcLog4jAppender instance = null;
    ...
    public void save(Map<String, TimingStatistics> timingStatisticsMap, long interval, TimeUnit timeUnit) {
        ...
        if (state == FAIL) {
            LogLog.error("SQLite Gather has fatal error->" + fail_message);
        } else {
    ...
    private void init() {
        ...
        try {
            ...
            LogLog.debug("driver[" + driver + "] load suc");
        ...
        try {
            ...
            if (db_type_enum == DB_TYPE_ENUM.SQLite) {
                ...
                try {
                    ...
                    LogLog.debug("connection url is " + url);
                } catch (Exception e) {
                ...
                try {
                    ...
                    LogLog.debug("sqlite file location is " + file.getAbsolutePath());
                } catch (Exception e) {
        ...
        instance = this;
        LogLog.debug("apm aggregate[" + db_type_enum + "] init suc!");
    ...
    public static JdbcLog4jAppender getInstance() {
        return instance;
    }
