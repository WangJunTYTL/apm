...
import com.peaceful.apm.aggregate.Log4jGraphingStatisticsAppender;
 ...
 * @version 1.0 16/7/13
 */
public class Log4jBaiduEchartGraphingServlet extends AbstractGraphingServlet {
    ...
    protected List<String> getAllKnownGraphNames() {
        ...
        for (Log4jGraphingStatisticsAppender appender : Log4jGraphingStatisticsAppender.getAllGraphingStatisticsAppenders()) {
    ...
    protected StatisticsChartGenerator getGraphByName(String name) {
        Log4jGraphingStatisticsAppender appender = Log4jGraphingStatisticsAppender.getAppenderByName(name);
